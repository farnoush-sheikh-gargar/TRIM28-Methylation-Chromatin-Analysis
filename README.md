...
Starting from a broad methylation difference between Light and Heavy **Trim28+/D9** mice, this analysis progressively narrowed the signal to a mechanistically relevant subset of loci.

The strongest pattern was a **TRIM28-linked repressive chromatin signature within the Heavy-up methylation state**. A subset of those loci could be carried into the human genome, where they showed a combination of accessible and H3K9me3-associated chromatin states and a significant local enrichment near H3K9me3.

This provides a focused next question for future work: **whether TRIM28-associated chromatin organization contributes to the establishment or maintenance of the divergent DNA methylation states.**
